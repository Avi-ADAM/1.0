...
let searchText = $state(``);
  ...
  /** @type {{bgi?: string, valc?: string, data?: any, meData?: any, datan?: string, addS?: boolean, kish: any, linkp?: string, addSl?: boolean, placeholder?: string, Valname?: string, masss?: boolean, addR?: boolean, addW?: boolean, width?: number}} */
  let {
    bgi = "wow",
    valc = "skillName",
    data = $bindable([]),
