...
*/
  ...
  let u = 'הצבעה על בקשת משאב לרקמה';
  let hovered = $state(false);
  function hover(id) {
    if (id == '0') {
      u = 'הצבעה על בקשת משאב לרקמה';
    } else {
      u = id;
    }
    onHover?.({ id: u });
  ...
  function hoverc(event) {
    if (event.x == '0') {
      u = 'הצבעה על פרסום הצעת משאב לרקמה';
    } else {
      u = event.x;
    }
    onHover?.({ id: u });
    ...
    >
      ...
      <SwiperSlide class="swiper-slideg">
          ...
          {:else if kindOf === 'perUnit'}
            <p class="p">
              <span
                ...
                onmouseleave={() => hover('0')}
                style="color:var(--gold)">{easy > 0 ? easy : price}</span
              >
              *
              <span
                onmouseenter={() => hover('כמות')}
                onmouseleave={() => hover('0')}
                style="color: aqua">{hm}</span
              >
              =
              <span
                onmouseenter={() => hover('סך הכל')}
                onmouseleave={() => hover('0')}
                >{easy > 0 ? easy * hm : price * hm}</span
              >
            </p>
            ...
            <p class="p">
              ...
              *
              <span
                ...
                onmouseleave={() => hover('0')}
                style="color: aqua">{monts}</span
              >
              =
              <span
                onmouseenter={() => hover('סך הכל')}
                onmouseleave={() => hover('0')}
                >{easy > 0 ? easy * monts : price * monts}</span
              >
            </p>
        ...
        ><div id="normSmll">
          ...
          {#if descrip !== undefined || null}<h5
              style:visibility={descrip !== undefined || null
                ? 'hidden'
                : 'visible'}
          ...
          {#if hearotMeyuchadot !== undefined || null || 'undefined'}<h6
              style:visibility={hearotMeyuchadot !== undefined ||
              null ||
              'undefined'
                ? 'hidden'
                : 'visible'}
              onmouseenter={() => hover('הערות מיוחדות')}
              onmouseleave={() => hover('0')}
              class="pnn cd"
            >
              {hearotMeyuchadot}
  ...
  -->
     ...
     -->
              <button
                ...
                onmouseleave={() => hover('0')}
                class="text-barbi btn j c"
                onclick={() => tochat()}><Chaticon class="btin" /></button
              >
            ...
            {:else}
              <button
                ...
                onmouseleave={() => hover('0')}
                class="text-barbi btn re flex items-center"
