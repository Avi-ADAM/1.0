...
function hoverc (event){
 ...
 import Cards from './cards/pma.svelte'
  ...
  /** @type {{low?: boolean, isVisible?: boolean, modal?: boolean, coinlapach: any, mypos?: any, messege?: any, descrip?: string, projectName?: string, name?: string, hearotMeyuchadot?: string, kindOf?: string, src?: string, projectId: any, link?: any, noofusersOk: any, noofusersNo: any, noofusersWaiting: any, total?: number, noofusers: any, already?: boolean, created_at: any, mshaabId: any, hm: any, price: any, easy: any, sqadualed: any, sqadualedf: any, pendId: any, users: any, linkto: any, mysrc: any, diun?: any, order?: any, ordern?: number, timegramaId: any, restime: any, cards?: boolean}} */
  let {
    low = false,
    isVisible = false,
