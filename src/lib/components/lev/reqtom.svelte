...
`
  ...
  /** @type {{low?: boolean, modal?: boolean, isVisible?: boolean, coinlapach: any, deadline: any, projectName: any, openmissionName: any, myp: any, easy: any, price: any, useraplyname: any, src?: string, src2?: string, projectId: any, link?: string, linkU?: string, userId: any, missionDetails?: string, name: any, noofpu?: number, publicklinks: any, privatlinks: any, hearotMeyuchadot: any, nhours?: number, valph?: number, missId: any, id: any, openMid: any, st?: number, declined?: any, noofusersWaiting: any, uids: any, what: any, noofusersOk: any, noofusersNo: any, already?: boolean, pid: any, stylef?: string, askId: any, users: any, spid: any, cards?: boolean, chat?: any, order?: number}} */
  let {
    low = false,
