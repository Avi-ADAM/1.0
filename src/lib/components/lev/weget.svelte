...
u ="בקשה לאישור ביצוע משימה בהצלחה"
  ...
  /** @type {{low?: boolean, modal?: boolean, isVisible?: boolean, coinlapach: any, mId: any, kindOf: any, myp?: number, projectName: any, missionBName: any, useraplyname: any, src?: string, src2?: string, projectId: any, link?: string, linkU?: string, userId: any, name: any, spid: any, hm?: number, noofpu?: number, spnot: any, price?: number, easy?: number, agprice?: any, missId: any, id: any, openMid: any, st?: number, declined?: any, noofusersWaiting: any, uids: any, noofusersOk: any, noofusersNo: any, already: any, stylef?: string, askId: any, users: any, sqadualed: any, sqadualedf: any, cards?: boolean}} */
  let {
    low = false,
