<script>
  ...
  let {
    ...
    uids = $bindable(),
    noofusersOk = $bindable(0),
    noofusersNo = $bindable(0),
          ...
          <div style="--the:{stylef};">
            ...
            >
              ...
              <g
                onclick={() => linke('u')}
                onmouseenter={() =>
                  hover(` לחיצה למעבר לעמוד הפרופיל של ${useraplyname}`)}
          ...
          {#if kindOf === 'perUnit'}
            <p dir="ltr" class="p cd">
              <span
                ...
                onmouseleave={() => hover('0')}
                style="color:var(--gold)">{agprice}</span
              >
              *
              <span
