...
id: ${pendId}
  ...
  /** @type {{modal?: boolean, isVisible?: boolean, shear?: any, low?: boolean, sendpropic?: string, sendname?: string, respropic?: string, resname?: string, projectId?: string, kind?: string, projectName?: string, src?: string, myid?: string, pendId?: number, chat?: string, amount?: string, send?: string, recive?: string, sendcon?: boolean, coinlapach?: string, already?: boolean, whyno?: any, hervachti?: any, created_at: any, messege?: any, order?: any, cards?: boolean}} */
  let {
