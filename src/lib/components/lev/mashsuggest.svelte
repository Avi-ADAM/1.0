...
>
        ...
        <a sveltekit:prefetch  href={`${linki}${projectId}`}><h3 class="hover:text-barbi lt" >{projectName}</h3></a>
        <h1 style="color: var(--barbi-pink); " class="ltn">{mashName}</h1>
        <h3 class="ltn" >{price}</h3>
...
use:clickOutside on:click_outside={toggleShow}>
    ...
    <a sveltekit:prefetch  href={`${linki}${projectId}`}><h3 class="hover:text-barbi ltb" >{projectName}</h3></a>
    <h3 class="lt">{mashName}</h3>
    <h6 class="ltn" style=" line-height: 0.7;">{descrip}</h6>
    <h5 class="lt">{spnot}</h5>
    <h3 class="ltn" >{price}</h3>
{#if already === false}
