...
<<<<<<< HEAD
  /** @type {{low?: boolean, isVisible?: boolean, projectName: any, restime: any, src: any, src2: any, openmissionName: any, missionDetails: any, useraplyname: any, noofusersNo: any, noofusersOk: any, noofusersWaiting: any, deadline: any, spdata: any, kind: any, price: any, already?: boolean, timegramaDate: any}} */
  let {
    low = false,
    isVisible = false,
    projectName,
...
>
  ...
  <div
    class="d bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
  >
    <div class="mb-8">
      {#if kind == 'sheirutpends'}
        <h1 class="text-gray-900 font-bold text:2xl sm:text-3xl mb-2">
...
on:keypress={preventSwiperScroll} dir="rtl"  style="overflow-y:auto" class=" d {isVisible ? $lang == 'he' ? 'boxleft' : 'boxright' : ''} leading-normal {isMobileOrTablet() ? "w-full h-full" : " w-[90%] h-[90%]"} bg-white lg:w-[90%]">
   ...
   <div class="flex sm:items-center justify-between py-3 border-b-2 border-b-gray-200 bg-gradient-to-br from-gra via-grb via-gr-c via-grd to-gre">
      <div class="relative flex items-center space-x-1">
         ...
         <div class="flex flex-col leading-tight">
            <div class=" text-md mt-1 flex items-center">
               <span class="text-barbi text-center mr-3 sm:text-xl text-sm">{tr?.headers[kind][$lang]}</span>
            </div>
  ...
  <div  class="{isScrolable ? "bg-white" : "bg-gray-200"} transition-all-300  rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
    <div  class="mb-8">
        {#if kind == "sheirutpends"}
          ...
          <p class="text-gray-900 font-bold text-xl mb-2">{spdata.sheirut.data.attributes.descrip}</p>
          <h5 class="text-barbi font-bold text-xl mb-2">⚙️{spdata.sheirut.data.attributes.oneTime ? oneTimeTr[$lang]:oneTimeFl[$lang]}</h5>
