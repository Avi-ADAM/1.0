<script>
 ...
 const dispatch = createEventDispatcher();
  ...
  import No from '../../../celim/no.svelte'
    export let projectName, src, perhour, noOfHours, missionDetails, missionName
      ...
      <div class="relative flex items-center space-x-1">
         ...
         <div class="flex flex-col leading-tight">
            <div class="sm:text-sm text-md mt-1 flex items-center">
               <span class="text-barbi text-center mr-3 sm:text-sm text-sm">הצעה למשימה בריקמה</span>
            </div>
