...
>
  ...
  <div
    class="flex sm:items-center justify-between py-3 border-b-2 border-b-gray-200 bg-liteGoldTobr"
  >
    <div class="relative flex items-center space-x-1">
      ...
      <div class="flex flex-col leading-tight ml-4">
        ...
        <div
          style="color: #b45309; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);"
          class="font-bold leading-tight text-lg sm:text-2xl"
        >
          {missionBName}
        </div>
      </div>
  ...
  >
    <div class="mb-8">
      <div
        style="line-height: 1;"
        class="text-base sm:text-lg text-gray-600 flex items-center"
      >
        <img
          style="width:2.5rem;"
          class=""
          ...
          <p>
            ...
            *
            <span
              ...
              onmouseleave={() => hover('0')}
              style="color:var(--barbi-pink);"
              >{hm == 1 ? `${oneunit[$lang]}` : `${hm} ${units[$lang]}`}</span
            >
            =
            <span
      ...
      {#if spnot !== null && spnot !== 'null' && spnot !== 'undefined' && spnot !== undefined}
        <p class="cd d max-h-16 text-gray-700 text-base sm:text-lg">{spnot}</p>{/if}
      <!-- {#if hearotMeyuchadot}
      ...
      <div class="text-base sm:text-lg"></div>
        ...
        <p class="vo ef">
          <span
            ...
            onmouseleave={() => hover('0')}
            style="color:#7EE081;">{noofusersOk}-{bead[$lang]}</span
          >
          <span
            role="contentinfo"
            ...
            onmouseleave={() => hover('0')}
            style="color:#0000cc;"
            >{noofusersWaiting}-{notyet[$lang]}
          </span><span
            role="contentinfo"
            onmouseenter={() => hover()}
            onmouseleave={() => hover('0')}
            style="color:#80037e;">{noofusersNo}-{neged[$lang]}</span
          >
        </p>
      </div>
    </div>
