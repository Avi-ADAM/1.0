  ...
  >
    <div class="mb-8">
      ...
      >
        ...
        />
        <span
          onmouseenter={() => hover(`${tri.common.valph[$lang]}`)}
        ...
        *
        <span
          ...
          onmouseleave={() => hover('0')}
        >
          {nhours.toLocaleString('en-US', { maximumFractionDigits: 2 })}
        ...
        <span
          ...
          onmouseleave={() => hover('0')}
          >{(nhours * valph).toLocaleString('en-US', {
      ...
      {#if missionDetails !== null && missionDetails !== 'null' && missionDetails !== 'undefined' && missionDetails !== undefined}
        <p class="cd d max-h-16 text-gray-700 text-base">
          {missionDetails}
        </p>{/if}
      {#if hearotMeyuchadot}
        <p
          ...
          onmouseleave={() => hover('0')}
          class="text-grey-700 max-h-16 cd text-sm d"
        >
      ...
      <div class="flex items-center border border-gold flex-col">
        {#if why !== undefined && why !== null && why !== 'undefined'}
          {#if why.startsWith('http')}
            <a
              ...
              onmouseleave={() => hover('0')}
              class="text-grey-700 max-h-16 max-w-full cd text-sm d hover:text-barbi"
              target="”_blank”"
              href={why}>link</a
            >
          {:else}
        ...
        {#if whatt}
          <a
            ...
            onmouseleave={() => hover('0')}
            href={whatt}
            class="text-barbi hover:text-gold">{tr.finiapp.file[$lang]}</a
          >
        {/if}
      </div>
    </div>
