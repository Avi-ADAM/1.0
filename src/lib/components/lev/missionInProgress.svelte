<script>
  ...
  let img =
    'https://res.cloudinary.com/love1/image/upload/v1648817031/maskable_icon_x128_tt2kgj.png';
 ...
 * $: if (percentage(zman,mstotal) >= 100 && running == true){
  ...
  let errorM = {
    ein: 'יש להעלות קובץ המכיל את ביצוע המשימה או לתאר במילים',
...
{#if storeTimer}
  <TimerDialogs
    ...
    onUpdateTimer={({ timer: updated, running, hoursdon: donenow }) => {
      ...
      // Outside the branch above on purpose: a save is exactly the case that
      // moves the monthly counter *and* carries no timer, so nesting this in
      // the `updated` branch dropped the new hours every time.
  ...
  <div transition:fly|local={{ y: 450, opacity: 0.5, duration: 2000 }}>
    <DialogContent aria-label="form" class="content">
      ...
      >
        <button
          onclick={close}
          class="absolute top-4 {$locale === 'he' || $locale === 'ar'
            ? 'left-4'
            : 'right-4'} text-gray-500 hover:text-gray-700"
        >
        ...
        {#if a == 1}
          <div class="space-y-4">
            <h5 class="text-xl font-semibold text-gray-800">
              {$t('lev.missionInProgress.uploadTitle')}
            </h5>
            <p class="text-sm text-gray-600">
              {$t('lev.missionInProgress.uploadDescription')}
            </p>

            <div class="space-y-3">
              <label class="block">
                <span class="text-sm font-medium text-gray-700"
                  >{$t('lev.missionInProgress.fileLabel')}</span
                >
                <input
                  type="file"
                  bind:files={what}
              ...
              <label class="block">
                <span class="text-sm font-medium text-gray-700"
                  >{$t('lev.missionInProgress.descriptionPlaceholder')}</span
                >
                <textarea
                  bind:value={why}
                  placeholder={$t(
                    'lev.missionInProgress.descriptionPlaceholder'
                  )}
                  rows="4"
          ...
          >
            ...
            <defs>
              ...
              <linearGradient id="linearGradient3938" bx:pinned="true">
                /*$$__STYLE_CONTENT__$$*//googleapis.com/css2?family=Abel%3Aital%2Cwght%400%2C400&amp;display=swap);style="stop-color:#ffdd55;stop-opacity:1"
                offset="0.257"/>
              ...
              <linearGradient id="gradient-2879" bx:pinned="true">
                <stop
                  offset="0"
                  style="stop-color: rgba(86, 251, 185, 0.25);"
                />
                ...
                <stop
                  offset="0.929"
                  style="stop-color: rgba(255, 0, 247, 0.4);"
                />
              </linearGradient>
              ...
              <linearGradient id="linearGradient7080" bx:pinned="true">
                <stop
                  id="stop7082"
                  style="stop-color:#bd8328;stop-opacity:1"
                  offset="0"
                />
                <stop
                  id="stop7084"
                  style="stop-color:#fbec9b;stop-opacity:1"
                  offset="0.1328"
                />
                <stop
                  id="stop7086"
                  style="stop-color:#f6e9a0;stop-opacity:1"
                  offset="0.2148"
                />
                <stop
                  id="stop7088"
                  style="stop-color:#bd984a;stop-opacity:1"
                  offset="0.5038"
                />
                <stop
                  id="stop7096"
                  style="stop-color:#c09d4e;stop-opacity:1"
                  offset="0.5896"
                />
                <stop
                  id="stop7090"
                  style="stop-color:#faf994;stop-opacity:1"
                  offset="0.8202"
                />
                <stop
                  id="stop7094"
                  style="stop-color:#bd8524;stop-opacity:1"
                  offset="1"
                />
              </linearGradient>
              <linearGradient id="linearGradient6333" bx:pinned="true">
                <stop
                  id="stop6335"
                  style="stop-opacity: 1; stop-color: rgb(0, 255, 98);"
                  offset="0"
                />
                <stop
                  id="stop6349"
                  style="stop-color:#f9fe92;stop-opacity:1"
                  offset="0.789"
                />
                <stop
                  id="stop6341"
                  style="stop-opacity: 1; stop-color: rgb(255, 239, 252);"
                  offset="1"
                />
                <stop
                  id="stop6337"
              ...
              <linearGradient id="linearGradient3964" bx:pinned="true">
                <stop
                  id="stop3966"
                  style="stop-color:#c0842d;stop-opacity:1"
                  offset="0"
                />
                <stop
                  id="stop3972"
                  style="stop-color:#f0de72;stop-opacity:1"
                  offset="0.5269"
                />
                <stop
                  id="stop3968"
                  style="stop-color:#eaef9e;stop-opacity:1"
                  offset="1"
                />
              </linearGradient>
              <linearGradient id="linearGradient3928" bx:pinned="true">
                ...
                <stop
                  id="stop3936"
                  style="stop-opacity: 1; stop-color: rgb(120, 105, 234);"
                  offset="0.5"
                />
                <stop
                  id="stop3932"
                  style="stop-color:#bb8930;stop-opacity:1"
                  offset="1"
                />
              </linearGradient>
              ...
              <path
                id="text-path-0"
                d="M 100.38671826695645 154.8521511401658 Q 153.42986825880143 111.41786914965459 206.47301825064642 153.87258003183285"
              />
            ...
            <path
              id="path-1"
              d="M 319.633 333.287 L 328.789 226.373 L 331.915 333.287 L 325.774 376.477 L 319.633 333.287"
              style="fill: url(#rg1-1); stroke: url(#gradient-2);"
              transform="matrix(0, 1, -1, 0, 627.198997, -24.349007)"
            />
            <path
              id="mhand"
              d="M 292 300 L 299.141 21.134 L 308 300 L 300 350 L 292 300"
            />
            <circle
              cx="298.697"
              cy="298.794"
            ...
            <g transform="matrix(1, 0, 0, 1, 7.731958, 16.323034)">
              <g transform="matrix(1, 0, 0, 1, 0, 136.020615)">
                <path
                  id="path-3"
                  d="M 326.505 333.769 L 333.739 223.796 L 336.21 333.769 L 331.357 378.195 L 326.505 333.769"
                  style="fill: url(#rg1-3); stroke: url(#gradient-4);"
                  transform="matrix(0, 1, -1, 0, 632.353004, -30.361992)"
                />
              </g>
            </g>
            <g
            ...
            <g>
              ...
              >
                <g
                  transform="matrix(0.876067, -1.904102, 2.169019, 0.860512, 460, 470)"
                >
                  <path
...
-->
      ...
      <SwiperSlide class="swiper-slideg">
        <div id="normSmll">
          <div
            onmouseenter={() => hover('זמן שכבר בוצע')}
            onmouseleave={() => hover('0')}
            class="mn ab"
          >
            {formatTime(zman)}
          ...
          <h5 dir="ltr" class="mn cd">
            <span
              onmouseenter={() => hover('מספר השעות שבוצעו ונשמרו')}
              onmouseleave={() => hover('0')}
              >{`${hoursdon ? Math.round((hoursdon + Number.EPSILON) * 100) / 100 : 0}`}</span
            >
            /
            <span
              onmouseenter={() => hover('מספר השעות שהוקצו למשימה')}
              onmouseleave={() => hover('0')}>{hourstotal}</span
            >
          </h5>
          ...
          {#if link != null && link != undefined && link != 'undefined'}
            <a
              onmouseenter={() => hover('לינק לביצוע המשימה')}
              onmouseleave={() => hover('0')}
