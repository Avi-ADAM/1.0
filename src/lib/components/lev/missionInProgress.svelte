...
<br/>
    <br />
    <button1 title="סיימתי" on:click={done}   class="btn a" name="done"><i class="far fa-check-circle"></i></button1>
        <button3 on:click={handleRunClick} class="btn b" name="start timer" title= {running ? 'Stop' : 'Start'}><i class="fas fa-hourglass-start"></i></button3>
   <!--<button2 class="btn" title="request more time" name="request more time"><i class="far fa-calendar-plus"></i></button2>-->
