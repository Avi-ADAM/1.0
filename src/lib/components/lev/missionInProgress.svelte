   ...
   <foreignObject  x='300' y='105' width='100' height='100' transform='translate(-50 -50)'>   
    <span class="{`normSml${perhour}-${projectId}-${mId}`}"></span>
     ...
     <path transform="matrix(1.4, 0, 0, 1.4 , 20, 280)" fill="transparent" stroke="transparent" id="curveooo" d=" M 0 0 A 200 200 0 0 0 400 0" />
            <text x="{tx}">
            <textPath font-size="50"  xlink:href="#curveooo">
                  <tspan dy="-5">{missionName}</tspan>
                </textPath>
        </text> 
<!--
