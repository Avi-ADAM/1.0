      ...
      <SwiperSlide class="swiper-slideg"
        ><div id="normSml">
          ...
          <svg
            in:scale={{ duration: 3200, opacity: 0.5, start: 1.56 }}
            version="1.1"
            viewBox="6.323 104.09 165.22 165.22"
          ...
          >
            <defs>
              ...
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.70867 0 0 .70867 359.72 66.468)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.71583 0 0 .71583 358.26 64.677)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.72306 0 0 .72306 356.77 62.868)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.73036 0 0 .73036 355.28 61.04)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.73774 0 0 .73774 353.76 59.195)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.74519 0 0 .74519 352.24 57.33)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.75272 0 0 .75272 350.69 55.446)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.76032 0 0 .76032 349.13 53.544)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.768 0 0 .768 347.56 51.622)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
                ...
                y1="133.6"
                y2="358.89"
                gradientTransform="matrix(.77576 0 0 .77576 345.97 49.681)"
                gradientUnits="userSpaceOnUse"
                xlink:href="#sugzzk"
              />
              <linearGradient
              ...
              <linearGradient
                ...
                xlink:href="#sugzzk"
              />
              <style bx:fonts="Almendra SC" bx:pinned="true">
                @import url(https://fonts.googleapis.com/css2?family=Almendra+SC%3Aital%2Cwght%400%2C400&amp;display=swap);
              </style>
              <linearGradient
                id="sugzzt"
                x1="501.76"
                ...
                y1="130.26"
                y2="148.42"
                gradientTransform="translate(3.1581 .39477)"
                gradientUnits="userSpaceOnUse"
              >
              ...
              <linearGradient
                ...
                y1="130.26"
                y2="148.42"
                gradientTransform="translate(3.5029 209.29)"
                gradientUnits="userSpaceOnUse"
              >
                <stop stop-color="rgba(255, 0, 119, 1)" offset="0" />
                <stop stop-color="rgba(153, 0, 71, 1)" offset="1" />
              ...
              <linearGradient
                ...
                y1="130.26"
                y2="148.42"
                gradientTransform="translate(18.967 78.624)"
                gradientUnits="userSpaceOnUse"
              >
                <stop stop-color="rgba(255, 0, 119, 1)" offset="0" />
                <stop stop-color="rgba(153, 0, 71, 1)" offset="1" />
              ...
              <linearGradient
                ...
                y1="130.26"
                y2="148.42"
                gradientTransform="translate(-41.849 155.28)"
                gradientUnits="userSpaceOnUse"
              >
                <stop stop-color="rgba(255, 0, 119, 1)" offset="0" />
                <stop stop-color="rgba(153, 0, 71, 1)" offset="1" />
              ...
              <path
                id="sugzzm"
                d="m404.32 246.15c-0.72-39.92 14.183-47.064 25.232-62.343 16.139-22.317 46.924-37.219 81.045-34.807 47.034 3.325 85.126 44.164 93.3 94.682"
              />
              <path
                id="sugzzl"
                d="m392.45 266.77c60.391 147.72 227.04 80.25 221.93-6.468"
              />
            ...
            <path
              d="m28.476 172.78s16.516-49.799 63.258-49.052c43.29 0.692 59.774 49.179 59.774 49.179"
            ...
            <g transform="matrix(.68728 0 0 .68728 -256.98 19.011)" style="">
              <path
                transform="matrix(1.0121 0 0 1.0121 296.09 -9.4615)"
                d="m322.86 250.22a117.86 117.86 0 1 1-235.71 0 117.86 117.86 0 1 1 235.71 0z"
                fill="#808080"
                filter="url(#sugzzaa)"
              />
              <path
              ...
              />
              <path
                transform="matrix(.97576 0 0 .97576 304.26 -.36265)"
                d="m322.86 250.22c0 90.727-98.214 147.43-176.79 102.07-36.465-21.054-58.928-59.961-58.928-102.07 0-74.795 66.75-126.47 134.22-116.89 14.37 2.04 28.773 6.858 42.57 14.824 36.465 21.053 58.928 59.961 58.928 102.07z"
                fill="url(#sugzzq)"
                stroke="url(#sugzzn)"
                stroke-width="4.8048px"
              />
              <path
                transform="matrix(.82424 0 0 .82424 336.03 37.549)"
                d="m322.86 250.22a117.86 117.86 0 1 1-235.71 0 117.86 117.86 0 1 1 235.71 0z"
                fill="url(#sugzzp)"
                stroke="url(#sugzzo)"
              />
              <g>
                <path
                  d="m596.43 243.79c0 50.495-40.934 91.429-91.429 91.429s-91.429-40.934-91.429-91.429c0-50.495 40.934-91.429 91.429-91.429s91.429 40.934 91.429 91.429z"
                  fill="url(#sugzza)"
                />
                <path
                  d="m595.51 243.79c0 49.99-40.525 90.514-90.514 90.514s-90.514-40.525-90.514-90.514c0-49.99 40.525-90.514 90.514-90.514s90.514 40.525 90.514 90.514z"
                  fill="url(#sugzzb)"
                />
                <path
                  d="m594.61 243.79c0 49.49-40.119 89.609-89.609 89.609s-89.609-40.119-89.609-89.609c0-49.49 40.119-89.609 89.609-89.609s89.609 40.119 89.609 89.609z"
                  fill="url(#sugzzc)"
                />
                <path
                  d="m593.71 243.79c0 48.995-39.718 88.713-88.713 88.713s-88.713-39.718-88.713-88.713c0-48.995 39.718-88.713 88.713-88.713s88.713 39.718 88.713 88.713z"
                  fill="url(#sugzzd)"
                />
                <path
                  d="m592.83 243.79c0 48.505-39.321 87.826-87.826 87.826s-87.826-39.321-87.826-87.826c0-48.505 39.321-87.826 87.826-87.826s87.826 39.321 87.826 87.826z"
                  fill="url(#sugzze)"
                />
                <path
                  d="m591.95 243.79c0 48.02-38.928 86.948-86.948 86.948s-86.948-38.928-86.948-86.948c0-48.02 38.928-86.948 86.948-86.948s86.948 38.928 86.948 86.948z"
                  fill="url(#sugzzf)"
                />
                <path
                  d="m591.08 243.79c0 47.54-38.539 86.078-86.078 86.078s-86.078-38.539-86.078-86.078c0-47.54 38.539-86.078 86.078-86.078s86.078 38.539 86.078 86.078z"
                  fill="url(#sugzzg)"
                />
                <path
                  d="m590.22 243.79c0 47.064-38.153 85.217-85.217 85.217s-85.217-38.153-85.217-85.217c0-47.064 38.153-85.217 85.217-85.217s85.217 38.153 85.217 85.217z"
                  fill="url(#sugzzh)"
                />
                <path
                  d="m589.37 243.79c0 46.594-37.772 84.365-84.365 84.365s-84.365-37.772-84.365-84.365c0-46.594 37.772-84.365 84.365-84.365s84.365 37.772 84.365 84.365z"
                  fill="url(#sugzzi)"
                />
                <path
                  d="m588.52 243.79c0 46.128-37.394 83.522-83.522 83.522s-83.522-37.394-83.522-83.522c0-46.128 37.394-83.522 83.522-83.522s83.522 37.394 83.522 83.522z"
                  fill="url(#sugzzj)"
                />
              ...
              <text
                transform="matrix(1.005 0 0 1.005 -.7373 -6.4393)"
                fill="url(#sugzzt)"
                font-size="17px"
                stroke="url(#sugzzz)"
                stroke-miterlimit="0"
                ...
                ><textPath startOffset={hst} xlink:href="#sugzzm"
                  >{projectName}</textPath
                ></text
              >
              ...
              <text
                ...
                stroke-miterlimit="0"
                stroke-width=".62511px"
                style="white-space:pre; fill:white; font-family: Gan, Powerr; stroke-width: 0; cursor: pointer;"
                ><textPath
                  startOffset={stb}
                  xlink:href="#sugzzl"
                  onmouseenter={() =>
              ...
              <g>
                <path
                  d="m503.92 247.08 83.779 36.861s-27.955 50.743-83.36 51.943c-49.464 1.072-82.103-53.618-82.103-53.618l81.684-35.186z"
                  fill="rgba(216, 216, 216, 0)"
                  stroke="rgba(0, 0, 0, 0)"
                >
                </path>
                <text
                  transform="matrix(1 0 0 1 100.04 -13.744)"
                  style="fill:url(#sugzzv); stroke-width: 0; font-family: gan, Powerr;"
                  x="402.493"
                  text-anchor="middle"
                  y="299.752"
                  fill="url(#sugzzv)"
            ...
            <g>
              <path
                d="m39.377 159.37 102.12 1.34 4.557 10.454-55.753 13.939-55.754-16.887 4.825-8.846z"
                fill="rgba(216, 216, 216, 0)"
                stroke="rgba(0, 0, 0, 0)"
              >
              </path>
