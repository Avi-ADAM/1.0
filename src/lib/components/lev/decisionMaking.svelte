...
const oldob = {"he":"הלוגו העכשווי", "en":"old Logo"}
  /** @type {{isVisible?: boolean, low?: boolean, kind: any, messege: any, myid: any, userId: any, spdata: any, newpicid: any, coinlapach: any, deadline: any, projectName: any, openmissionName: any, src?: string, src2?: string, projectId: any, created_at: any, missionDetails?: string, noofpu?: number, id: any, openMid: any, st?: number, declined?: any, noofusersWaiting: any, uids: any, noofusersOk: any, noofusersNo: any, already?: boolean, pid: any, stylef?: string, askId: any, users: any, timegramaDate: any, restime: any, timegramaId: any, cards?: boolean, tx?: number, modal?: boolean}} */
  let {
    isVisible = false,
    low = false,
    kind,
