...
><div class="{`normSmll${pendId}`} "></div>
	  <img on:click={project(projectId)} src={src} class="img ab" alt="projectlogo" title={`${projectName}לחיצה למעבר ללוח הבקרה של ריקמת `}>
