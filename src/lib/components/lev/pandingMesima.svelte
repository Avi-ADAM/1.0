...
onMount(() => {
    ...
    tafkidims = oneLangAdj({
        data: tafkidims
    }, $lang, "roleDescription").data || []
    workways = oneLangAdj({
        data: workways
    }, $lang, "workWayName").data || []
})
...
import {
    oneLangAdj
} from '$lib/func/oneLangAdj.svelte';
import {
    lang
          ...
          ><div id="normSml">
            ...
            <p class="p">
              <span
                ...
                onmouseleave={() => hover('0')}
                style="color:var(--gold)">{perhour}</span
              >
              *
              <span
                onmouseenter={() => hover('כמות השעות')}
                onmouseleave={() => hover('0')}
                style="color: aqua">{noofhours}</span
              >
              =
              <span
          ...
          ><div id="normSmll">
            ...
            <button onclick={() => linke()} class="ab na">
              <h3
                class="ab na"
                onmouseenter={() =>
                  hover('לחיצה לצפיה בעמוד הציבורי של הריקמה')}
                onmouseleave={() => hover('0')}
              >
                {projectName}
              </h3>
            ...
            <p
              ...
              class="pnn bc d"
            >
              {descrip !== undefined && descrip != null && descrip != 'null'
                ? descrip
                : ''}
            </p>
            {#if hearotMeyuchadot}
