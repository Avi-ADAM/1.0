  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- ===== מעגל אחד, שתי כניסות =====
             עד כאן העמוד סיפר כיוון אחד בלבד: יזם שפותח רקמה, מגיעים שותפים,
             נולד מוצר, מגיע לקוח. הקונסיירז' שמתחת הוא אותו מעגל מהקצה
             השני - לקוח שמבקש משהו שעוד לא קיים, וסביב הבקשה שלו נבנית הרקמה
