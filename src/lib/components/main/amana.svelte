...
function find_contry_id(contry_name_arr){
    ...
    const country =  [
                    ...
                    { value: 201 , label: 'Korea, Democratic People\'s Republic of', heb: 'קוריאה הצפונית'},
                    { value: 160 , label: 'Korea, Republic of', heb: 'קוריאה הדרומית'},
                    ...
                    { value: 187 , label: 'San Marino', heb: ''},
