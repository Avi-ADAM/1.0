...
{see[$lang]}
    ...
    <a href="mailto:ehad1one@gmail.com" ><h3 class="text-gold bg-gradient-to-br hover:from-gra hover:via-grb hover:via-gr-c hover:via-grd hover:to-gre from-barbi to-mpink  hover:text-barbi px-2 rounded-full">{buttn[$lang]}</h3></a>
