<script>
  ...
  let defaultPlaceholder = $derived(tr.selector.searchValues[$lang]);
  ...
  // --- Messages ---
  const dupMsg = {
    he: { found: tr.selector.identicalValue.he, similar: tr.selector.similarValue.he, override: tr.ui.addAnyway.he },
    en: { found: tr.selector.identicalValue.en, similar: tr.selector.similarValue.en, override: tr.ui.addAnyway.en },
    ar: { found: tr.selector.identicalValue.ar, similar: tr.selector.similarValue.ar, override: tr.ui.addAnyway.ar }
  };
