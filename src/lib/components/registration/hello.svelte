<script>
  ...
  function slidefade(node, params) {
    ...
    return {
      ...
      css: (t, u) =>
        `translateY:(-40%); translateX: (50% ,100%); transform: ${existingTransform} scale(${t}); opacity: ${t};`
    };
  }
  let show_value;
...
>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox={`600 80 2222 918.656`}
    enable-background="new 0 0 2722.126 1518.656"
  ...
  >
    <defs>
      <radialGradient
        ...
        r="843.488"
        id="gradient-1"
        gradientTransform="matrix(1.964807, -0.050779, 0.025836, 0.999666, -1004.848942, 91.27403)"
      >
      ...
      <linearGradient
        ...
        y2="800.321"
        id="gradient-4"
        gradientTransform="matrix(1, 0, 0, 1, -5.591242, 39.141397)"
      >
      ...
      <linearGradient
        ...
        y2="488.636"
        id="gradient-2"
        gradientTransform="matrix(1, 0, 0, 1, -134.36475, 10.351013)"
      >
      ...
      <linearGradient
        ...
        y2="495.029"
        id="gradient-0"
        gradientTransform="matrix(0.182647, 1.404465, -7.705621, 2.048721, 4564.696447, -2884.876656)"
      >
    ...
    <text
      class="tex"
      style="white-space: pre; fill: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 42.6px;"
      x="1800.767"
      y="479.051"
    >
    </text>
...
<style>
  ...
  .button {
    ...
    animation: clockwise 20s ease-in-out 10s infinite;
  }
</style>
