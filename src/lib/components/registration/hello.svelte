...
<svg class="key" height="80%" width="80%" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="{`600 80 2222 918.656`}" enable-background="new 0 0 2722.126 1518.656" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="tex"  style="fill: url(#gradient-2); font-family: Arial, sans-serif; font-size: 62px; letter-spacing: 6.1px; stroke: url(#gradient-0); stroke-width: 2.29039px; text-anchor: middle; white-space: pre;" transform="matrix(1.540934, 0, 0, 1.078712, -522.814819, -41.794453)"><tspan x="1365.63" y="486.829">לחיצה לפתיחת          </tspan><tspan x="1365.63" dy="1em">​</tspan><tspan x="1365.63" dy="1em">​</tspan><tspan x="1365.63" dy="1em">​</tspan><tspan>1❤️1                </tspan></text>
