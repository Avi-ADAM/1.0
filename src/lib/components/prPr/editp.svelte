...
let suc = false;
  ...
  /** @type {{linkP: any, githublink: any, fblink: any, discordlink: any, drivelink: any, twiterlink: any, watsapplink: any, desP: any, desPl: any, projectName_value: any, restime: any, selected?: any}} */
  let {
    linkP = $bindable(),
    githublink = $bindable(),
    fblink = $bindable(),
