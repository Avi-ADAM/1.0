<script>
  ...
  /** @type {{idKey?: string, parentKey?: any, valueKey?: string, labelVisibilityThreshold?: any, fill?: string, stroke?: string, strokeWidth?: number, textColor?: string, textStroke?: string, textStrokeWidth?: number, sortBy?: any, spacing?: number}} */
  let {
    idKey = 'id',
    parentKey = undefined,
    valueKey = 'value',
