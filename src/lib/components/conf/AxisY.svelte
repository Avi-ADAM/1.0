...
<script>
  ...
  /** @type {{gridlines?: Boolean, tickMarks?: Boolean, formatTick?: Function, ticks?: Number|Array|Function, xTick?: Number, yTick?: Number, dxTick?: Number, dyTick?: Number, textAnchor?: String}} */
  let {
    gridlines = true,
    tickMarks = false,
    formatTick = d => d,
