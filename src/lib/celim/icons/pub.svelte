...
<svg
    ...
    id="Layer_1"
    style="enable-background:new 0 0 131.397 137.627; width:24px;height:24px"
    space="preserve"
...
></cc:license>
        ...
        >
        <dc:title
          >Architetto -- Foglio e mondo</dc:title
        >
        <dc:date
          >2009-06-30T13:35:03</dc:date
        >
        <dc:description
          >Blank paper and Earth icon by Francesco Rollandin. From OCAL 0.18 release.</dc:description
        >
        <dc:source
          >https://openclipart.org/detail/26916/architetto----foglio-e-mondo-by-anonymous</dc:source
        >
        <dc:creator
          >
          <cc:Agent
