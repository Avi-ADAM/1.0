...
<div class="flex mb-4">
    ...
    <div class="ms-2 text-sm">
        <label for="{name+diff}" class="font-medium text-lg text-barbi ">{lebel[lang]}</label>
        {#if helpText != null}
        <p id="helper-checkbox-text" class="text-sm font-normal text-barbi">{helpText[lang]}</p>
        {/if}
    </div>
</div>
