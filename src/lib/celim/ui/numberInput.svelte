...
export let barbi = false
export let noNegative = false
export let noMoreThen = -1
...
<form class="max-w-xs mx-auto flex items-center justify-center flex-col">
    ...
    <div class="relative flex items-center max-w-[8rem]">
        <button on:click={decrement} class="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
        ...
        <button on:click={increment} class="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
