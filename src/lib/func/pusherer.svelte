<script context="module">
    ...
    */
    export async function pusherer(jsonim = [],myid = 0,pic = 'https://res.cloudinary.com/love1/image/upload/v1645647192/apple-touch-icon_irclue.png',title = {"he":"","en":""},body = {"he":"","en":""},mainlang = "he",fetch){
      console.log(jsonim) 
