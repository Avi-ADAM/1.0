...
import TextInput from "$lib/celim/ui/input/textInput.svelte";
  ...
  <div
  class="inline-flex animate-shine items-center justify-center rounded-full text-xs border border-neutral-800 bg-[linear-gradient(110deg,#EEE8AA,45%,#d4c48b,55%,#EEE8AA)] bg-[length:200%_100%] px-3 py-1 font-medium text-neutral-900 transition-colors"
>
  Badge
</div>
