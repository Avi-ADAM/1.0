    ...
    data {
      ...
      if (meDataa.data != null) {
        if (meDataa.data.me.id === idL && meDataa.data.me != null) {
          ...
          if ($lang == 'he') {
            for (var p = 0; p < meData.vallues.data.length; p++) {
              if (
                meData.vallues.data[p].attributes.localizations.data.length > 0
              ) {
                meData.vallues.data[p].attributes.valueName =
                  meData.vallues.data[
                    p
          ...
          if ($lang == 'he') {
            for (var o = 0; o < meData.skills.data.length; o++) {
              if (
                meData.skills.data[o].attributes.localizations.data.length > 0
              ) {
                meData.skills.data[o].attributes.skillName =
                  meData.skills.data[
                    o
        ...
        <svg width="45vw" height="9vw" viewBox="0 0 500 100">
          ...
          <text width="500" id="text">
            <textPath
              ...
              class="curved-text"
              xlink:href="#curve"
              startOffset={st}>{meData.username}</textPath
            >
          </text>
        </svg>
      </div>
        ...
        {#if addNs1 == true}
          ...
          -->
            ...
            <TourItem message={message4[$lang]}>
              <div
                class="d"
                class:selectedl={current === 'a5' && mass !== true}
                class:a5={current !== 'a5'}
                class:whole={mass === true}
              >
                <Edit
...
>>>>>>> main
            ...
            >
                ...
                <span class="d pro">
                  {#each meData.projects_1s.data as data, i}
                    <div class="cont">
                      ...
                      >
                        <div
                          class="cont inline-flex items-center sm:text-xl mt-1 mr-2 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded bg-gradient-to-br from-mpink via-transparent via-lpink to-barbi"
                        >
              ...
              >
                <svg
                  ...
                  x="0px"
                  y="0px"
                  viewBox="0 0 1209.872 1699.001"
                  style="enable-background:new 0 0 1209.872 1699.001;"
                  xml:space="preserve"
                >
                  <g class="n svgh">
                    <path
                      class="st2 svgh"
                      d="M626.407,50.022c-7.193-0.778-14.386-0.539-21.585-0.225c-7.199-0.314-14.392-0.553-21.585,0.225
		...
		C1278.898,552.106,1058.01,57.057,626.407,50.022z"
                    ...
                    <g>
                      <path
                        class="st1 svgh"
                        d="M524.2,322.601c48.714,52.887,44.272,124.135-12.19,172.027c46.6,39.059,62.963,107.336,29.43,160.439
			...
			C167.241,497.084,324.8,511.164,278.695,614.9z"
                      ...
                      <path
                        class="st0 svgh"
                        d="M827.386,201.408c33.147-13.716,62.603,5.603,72.096,30.794c33.577,82.577-132.791,155.377-144.847,52.677
          ...
          <div class="anotheri">
            ...
            >
              ...
              <text
                ...
                ><tspan
                  >{total != null ? total : 0}<tspan x="0" dy="1em">​</tspan>
                </tspan><tspan x="0" dy="1em">​</tspan><tspan>💗</tspan></text
              >
            </svg>
          </div>
        </TourItem>
...
<style>
  ...
  .name:hover {
    transform: scale(1.5) translateY(-25%) translateX(-37.5%);
  }
  .pro {
    max-height: 15vh;
    overflow-y: scroll;
  ...
  .n {
    cursor: url(https://res.cloudinary.com/love1/image/upload/v1639255090/Fingerprint-Heart-II_wqvlih.svg),
      auto;
  }
