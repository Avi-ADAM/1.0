 ...
 * role) from anywhere in the app. Creating server-side (admin token) means it
...
export const POST: RequestHandler = async ({ request, fetch }) => {
	...
	return json({
		...
		// the client fires /api/translations only for clean items
		translate: !moderation.flagged
