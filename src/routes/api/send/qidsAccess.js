...
export const qidsAccess = {
  ...
  'githubContributorsByGithubIds': { allow: ['serviceAdmin'] },
  'githubUserById': { allow: ['serviceAdmin'] },
  'githubClaimMissions': { allow: ['serviceAdmin'] },
  'githubProjectLinkedTimers': { allow: ['serviceAdmin'] },
  ...
  '360getSheirutpendQuote': { allow: ['serviceAdmin'] },
  '361createSheirutnego': { allow: ['serviceAdmin'] },
  '362getActiveTimegramaForSheirutpend': { allow: ['serviceAdmin'] },
