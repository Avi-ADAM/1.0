...
# devDependency and therefore absent here (exit 127). Any patch-package patches
# are applied in stage 1b, where the full `npm ci` runs — the runtime
# node_modules never reads patch files directly.
