...
- S4b (2026-09-05): לדף ה-join נוסף לוח **"מה הריקמה מחפשת עכשיו"** —
  המשימות הפתוחות *וגם* המשאבים הפתוחים של הריקמה (qid
...
- S4c (2026-09-05): **חבר ריקמה רואה עכשיו את כל העמוד**, לא רק את כרטיס
...
- **צד המועמד (משאבים)** ✅: `appendMyPendingAskmEntries` ב-extractors
  ...
  בלב על ההצעה שלו: צ'אט (addAskmChatEntry), צפייה בנגדית של הריקמה
