...
| **Redirect on update** | ✅ לסמן | רלוונטי רק כשחבר באמת משנה הרשאות במסך ההתקנה ולוחץ Save — אז GitHub מחזיר אותו לבורר המאגרים. **החיבור כבר לא תלוי בזה:** הזרימה עוברת דרך OAuth, ולכן מי שה-App כבר מותקן אצלו מגיע ישר לבורר בלי לעבור במסך ההתקנה (§3.3) |
