...
|---|---|---|---|---|
| 1 | `S1_Intro.tsx` | 3.5ש | לוגו + שרשרת 5 שלבים (הרשמה→רקמה→משימות→אשרור→חלוקה) | — |
...
| `public/rikma-edit.png` | "אישור פרויקט" / עריכת הרקמה | `remotion/public/` |
...
| 4 | "מגדירים את הרקמה, עורכים פרטים, ומפרסמים — אחרי שכל השותפים אישרו." |
...
| 10 | "הקימו רקמה עכשיו, בחינם. 1lev1.com." |
