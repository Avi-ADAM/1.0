...
export const S10_ConsCTA: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 0}}>
      <div style={{opacity: mark, transform: `scale(${interpolate(mark, [0, 1], [0.7, 1])})`, marginBottom: 28}}>
        <Wordmark size={140} />
      </div>

      <div style={{
        ...line1,
        fontFamily: theme.font, fontWeight: 600, fontSize: 38,
        color: theme.colors.muted, direction: 'rtl', marginBottom: 30, textAlign: 'center',
      }}>
        תגידו מה אתם רוצים — הקהילה תגשים
      </div>
      ...
      <div style={{
        ...
        fontFamily: theme.font, fontWeight: 900, fontSize: 46,
